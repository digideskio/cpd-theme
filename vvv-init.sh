...
mysql -u root --password=root -e "GRANT ALL PRIVILEGES ON cpd-theme.* TO wp@localhost IDENTIFIED BY 'wp';"
...
then
	...
	wp core config --dbname="cpd-theme" --dbuser=wp --dbpass=wp --dbhost="localhost" --allow-root
